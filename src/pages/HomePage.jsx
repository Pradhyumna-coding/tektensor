...
var skills = [
  ...
  {
    skillName:"HTML",
    skillImage:"https://upload.wikimedia.org/wikipedia/commons/6/61/HTML5_logo_and_wordmark.svg"
  },
  {
    skillName:"CSS",
    skillImage:"https://upload.wikimedia.org/wikipedia/commons/3/3d/CSS.3.svg"
  },
  {
    skillName:"JavaScript",
    skillImage:"https://upload.wikimedia.org/wikipedia/commons/9/99/Unofficial_JavaScript_logo_2.svg"
  },
  {
        ...
        <div className="home">
                    ...
                    <GradientBorderDiv radius={10}>
                      {sports.map((sport) => (
                        <div style={{padding:"10px 2px 10px 2px"}}>
                          ...
                          <span class="material-symbols-outlined" style={{color:sport.iconColor}}>
                          {sport.iconText}
                          </span>
                          {sport.name}
                          </p>
            ...
            <div className="section" id="skills">
              ...
              <div className="grid two-column" id="youtube-div">
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/cit_A4T-0vU?si=sAYltRFKNhR4clle" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
                <div className="video-div">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/z_pIGfxUI-o?si=GPiQxKZ4CzAPnRvq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>

              </div>

              <p className="section-subheading">I have also completed learning Abacus from SIP abacus till GMC Level</p>

              <div className="grid two-column">
                <ListItem type="detailed" 
                  details={{name:"Abacus",
                  desc:"I have completed learning Abacus from SIP abacus till GMC Level",
                  image:"https://m.media-amazon.com/images/I/61v0RqAvxKL.jpg"}}/>
                <ListItem type="detailed" 
                  details={{name:"Rubics Cube",
            ...
            <div className="section" id="projects">
              ...
              <p className="section-subheading">I have been coding for past 5 years in variuos Languages and Frameworks</p>
